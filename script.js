...
function calcular() {
   ...
   let radiosEsquerda = document.getElementsByClassName("esquerda");
    ...
    let resultEsquerda = 0;
        ...
        if (resultEsquerda == resultDireita || resultEsquerda && resultDireita == 0){resultado.innerHTML = "De acordo com as suas respostas fornecidas ao questionário, seu perfil político é de Centro.";
